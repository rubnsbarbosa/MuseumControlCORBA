 ...
 */
public class MuseumGuardServer {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            GuardImplementation guard = new GuardImplementation();
            org.omg.CORBA.Object gateReference = rootPOA.servant_to_reference(guard);

            NameComponent[] guardName = {new NameComponent("Guard", "")};

            naming.rebind(guardName, gateReference);

            rootPOA.the_POAManager().activate();

            System.out.println("Server Guard Ready...");
