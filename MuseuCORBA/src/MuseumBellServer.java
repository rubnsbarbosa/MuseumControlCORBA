...
public class MuseumBellServer {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            BellImplementation bell = new BellImplementation();
            org.omg.CORBA.Object gateReference = rootPOA.servant_to_reference(bell);

            NameComponent[] gateName = {new NameComponent("Bell", "")};

            naming.rebind(gateName, gateReference);

            rootPOA.the_POAManager().activate();

            System.out.println("Server Bell Ready...");
